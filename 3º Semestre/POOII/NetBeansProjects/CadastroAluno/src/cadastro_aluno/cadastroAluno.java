...
public class cadastroAluno extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        aluno01.setNota1(Float.parseFloat(jTextField2.getText()));
        aluno01.setNota2(Float.parseFloat(jTextField3.getText()));
        aluno01.setNota3(Float.parseFloat(jTextField4.getText()));
        aluno01.setNota4(Float.parseFloat(jTextField5.getText()));
        
        aluno01.calculaMedia();
        jTextField6.setText(String.valueOf(aluno01.getMedia()));
        jLabel7.setText(aluno01.getNome() + ":" + aluno01.verificaAprovado());
